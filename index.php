...
<head>
    <meta charset="utf-8">
    <title>UK Tea &amp; Infusions Association - What is the UK Tea &amp; Infusions Association?</title>
    ...
    <div class="page">
        ...
        <div class="header">
            ...
            <ul class="aux-navigation">
                ...
                <li class="first"><a href="/log-in" title="Log-out">Log-in</a></li>
                ...
                <ul id="navigation-list" class="list">
                    <li class="first option-one has-dropdown"><a href="/about">About UKTIA</a>
                        <ul>
                            ...
                            <li class="last"><a href="/log-out">Members Log-out</a></li>
                        </ul>
                    </li>
                    <li class="option-two has-dropdown"><a href="/pulse">The Pulse</a>
                        <ul>
                    ...
                    <li class="option-three has-dropdown"><a href="/members-reference" class="active">Membership Reference Info</a>
                        <ul>
            ...
            <ul>
                ...
                <li><a href="/about">About UKTIA</a>
                    <ul>
                        ...
                        <li><a href="/log-out">Members Log-out</a></li>
                    </ul>
                </li>
                <li><a href="/pulse">The Pulse</a>
                    <ul>
                ...
                <li><a href="/members-reference" class="active">Membership Reference Info</a>
                    <ul>
