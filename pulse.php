                ...
                <div class="narrow right">
                    <div class="calendar-box">
                            ...
                            <tr>
                              ...
                              <span class="date" title="">
                                23
                                        ...
                                        <td class="day meeting">
                              <span class="date" title="UKTIA Technical Operating Group Meeting">
                                24
                              </span>
                                        </td>
                                        <td class="day ">
                        ...
                        <ul class="calendar-list">
                            <li>
                                <span class="topic">UKTIA Technical Operating Group Meeting</span>
                                <span class="sub-line">24th Apr 2015 - <a href="/actions-updates/article/uktia-technical-operating-group-meeting" title="UKTIA Technical Operating Group Meeting">View article</a></span>
                            </li>
                        </ul>
                    </div>
                </div>
