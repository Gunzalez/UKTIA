                    ...
                    <div class="listings essential-reading">
                        ...
                        <ul>
                            <li>
                                ...
                                <p><strong>Nullam et nisl ut nulla tristique mattis</strong> Curabitur semti stique mator vitae odio tincidunt egestas. <a href="log-in.php" title="Please log-in to view this article">Log-in to view</a></p>
                            </li>
                            <li>
                                <img src="uploaded/icon-bbc-news.png" alt="" width="45" height="45">
                                <p><strong>13/12/2014 Beats to the mix</strong> Nullam et nisl ut nulla tristique mattisnt egestas. <a href="log-in.php" title="Please log-in to view this article">Log-in to view</a></p>
                            </li>
                        </ul>
                    </div>
